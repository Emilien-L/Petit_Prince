...
public class QuasiConsole_OLD extends UnicastRemoteObject implements Console {
	...
	QuasiConsole_OLD (Sujet c) throws RemoteException {
		super();
		try{
			...
			System.out.println("(JAVABOY) Erreur : la console n'a pa pu etre creee !\nCause : "+e.getCause());
			//e.printStackTrace();
		}
	}
